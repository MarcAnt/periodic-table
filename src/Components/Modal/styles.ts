...
export const SingleElementModal = styled.div<IBgColor>`
    ...
    width: 50%;
    height: 80%;
    background-color: ${ props => selectedStateBgColor(props.standardState, props.color, props.atomicNumber, props.groupBlock) };
    text-align: center;
    padding: 1rem;
    margin-left: 1rem;
    box-shadow:  ${props => (props.atomicNumber !== 0) ? '1px 2px 5px lightgrey' : '' };
    display: flex;
