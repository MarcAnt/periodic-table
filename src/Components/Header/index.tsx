...
import {headerLang} from '../../Lang/es'
...
const Header: React.FC = () => {
    ...
    return (
        <HeaderStyles>
            ...
            <h1>{lang === 'es' ? headerLang.title :"Periodic Table of the Elements"}</h1>
            ...
            <div style={{display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
                ...
                <p> | {lang === 'es' ? headerLang.inspired : "Inspired by"} <a href="https://pubchem.ncbi.nlm.nih.gov/periodic-table/#view=table&property=GroupBlock" target="_blank" rel="noreferrer" >PUBCHEM</a> </p>
            </div>
